...
/**** bundleId ****/
"ion-modal.md.ion-modal-portal.md",
...
/***************** ion-modal.md *****************/
[
/** ion-modal.md: [0] tagName **/
'ion-modal',

/** ion-modal.md: [1] methods **/
0 /* no methods */,

/** ion-modal.md: [2] listeners **/
[
  [
    /***** ion-modal.md listener[0]  ionModalDismiss -> onDismiss() *****/
...
/** ion-modal.md: [3] watchers **/
0 /* no watchers */,

/** ion-modal.md: [4] shadow **/
0 /* do not use shadow dom */,

/** ion-modal.md: [5] modeName **/
2 /* md mode **/,

/** ion-modal.md: [6] styles **/
'/********** modal.md.scss **********/\n' + 
'\n' + 
'ion-modal {\n' + 
'  position: absolute;\n' + 
...
/***************** ion-modal-portal.md *****************/
[
/** ion-modal-portal.md: [0] tagName **/
'ion-modal-portal',

/** ion-modal-portal.md: [1] methods **/
0 /* no methods */,

/** ion-modal-portal.md: [2] listeners **/
[
  [
    /***** ion-modal-portal.md listener[0]  body:ionModalDidLoad -> viewDidLoad() *****/
  ...
  [
    /***** ion-modal-portal.md listener[1]  body:ionModalWillDismiss -> willDismiss() *****/
  ...
  [
    /***** ion-modal-portal.md listener[2]  body:ionModalWillPresent -> willPresent() *****/
  ...
  [
    /***** ion-modal-portal.md listener[3]  body:ionModalWillUnload -> willDismiss() *****/
    /* [0] methodName **/ 'willDismiss',
  ...
  [
    /***** ion-modal-portal.md listener[4]  body:keyup.escape -> escapeKeyUp() *****/
...
/** ion-modal-portal.md: [3] watchers **/
0 /* no watchers */,

/** ion-modal-portal.md: [4] shadow **/
0 /* do not use shadow dom */,

/** ion-modal-portal.md: [5] modeName **/
2 /* md mode **/,

/** ion-modal-portal.md: [6] styles **/
'/********** modal-portal.scss **********/\n' + 
'\n' + 
'ion-modal-portal {\n' + 
'  display: none;\n' + 
