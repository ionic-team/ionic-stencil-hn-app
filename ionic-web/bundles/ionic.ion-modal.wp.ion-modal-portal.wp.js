...
/**** bundleId ****/
"ion-modal.wp.ion-modal-portal.wp",
...
/***************** ion-modal.wp *****************/
[
/** ion-modal.wp: [0] tagName **/
'ion-modal',

/** ion-modal.wp: [1] methods **/
0 /* no methods */,

/** ion-modal.wp: [2] listeners **/
[
  [
    /***** ion-modal.wp listener[0]  ionModalDismiss -> onDismiss() *****/
...
/** ion-modal.wp: [3] watchers **/
0 /* no watchers */,

/** ion-modal.wp: [4] shadow **/
0 /* do not use shadow dom */,

/** ion-modal.wp: [5] modeName **/
3 /* wp mode **/,

/** ion-modal.wp: [6] styles **/
'/********** modal.wp.scss **********/\n' + 
'\n' + 
'ion-modal {\n' + 
'  position: absolute;\n' + 
...
/***************** ion-modal-portal.wp *****************/
[
/** ion-modal-portal.wp: [0] tagName **/
'ion-modal-portal',

/** ion-modal-portal.wp: [1] methods **/
0 /* no methods */,

/** ion-modal-portal.wp: [2] listeners **/
[
  [
    /***** ion-modal-portal.wp listener[0]  body:ionModalDidLoad -> viewDidLoad() *****/
  ...
  [
    /***** ion-modal-portal.wp listener[1]  body:ionModalWillDismiss -> willDismiss() *****/
  ...
  [
    /***** ion-modal-portal.wp listener[2]  body:ionModalWillPresent -> willPresent() *****/
  ...
  [
    /***** ion-modal-portal.wp listener[3]  body:ionModalWillUnload -> willDismiss() *****/
    /* [0] methodName **/ 'willDismiss',
  ...
  [
    /***** ion-modal-portal.wp listener[4]  body:keyup.escape -> escapeKeyUp() *****/
...
/** ion-modal-portal.wp: [3] watchers **/
0 /* no watchers */,

/** ion-modal-portal.wp: [4] shadow **/
0 /* do not use shadow dom */,

/** ion-modal-portal.wp: [5] modeName **/
3 /* wp mode **/,

/** ion-modal-portal.wp: [6] styles **/
'/********** modal-portal.scss **********/\n' + 
'\n' + 
'ion-modal-portal {\n' + 
'  display: none;\n' + 
